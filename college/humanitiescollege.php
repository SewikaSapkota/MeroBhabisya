...
<header class="page-heading clearfix" style="border-radius:400px;padding-bottom: 10px;">
  <h1 class="heading-title pull-left margin-top:10px; style="style="border-bottom-style:dotted;border-radius:400px;color: #f44336">Humanitities College in Nepal affiliated to TU </h1>
  <div class="breadcrumbs pull-right" style="border-bottom-style:groove;border-bottom-color:#EEEEEE; >
<ul class="breadcrumbs-list">
                            <a href="../homepage/index.php">Home</a>
                            <i class="fa fa-angle-right"></i>
                            <a href="humanitiescollege.php">Humanities</a>
...
$sql = "SELECT * FROM college where c_id BETWEEN 66 AND 85 ORDER BY c_id";
